...
import {MuiThemeProvider, Drawer, Hidden} from '@material-ui/core';
...
const styles = theme => ({
    ...
    header                        : {
        ...
        display        : 'flex',
        background     : 'linear-gradient(to right, #363c4a 0%, #363c4a 100%)',
    ...
    render()
    {
        ...
        return (
            ...
            >
                ...
                <div
                    className="flex flex-auto flex-col container z-10 col-md-12"
                    style={{
                        margin:0,
                        padding:0,
                        height:'100%'
